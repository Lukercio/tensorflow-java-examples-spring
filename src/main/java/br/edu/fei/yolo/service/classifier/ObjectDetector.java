package br.edu.fei.yolo.service.classifier;

import br.edu.fei.yolo.ApplicationProperties;
import br.edu.fei.yolo.model.Recognition;
import br.edu.fei.yolo.util.GraphBuilder;
import br.edu.fei.yolo.util.IOUtil;
import br.edu.fei.yolo.util.ImageUtil;
import br.edu.fei.yolo.util.ServiceException;
...
public class ObjectDetector {
    ...
    public ObjectDetector(final ApplicationProperties applicationProperties) {
        ...
        try {
            ...
            LOGGER.error("Any trained graph was found! \n" +
                    "You can use one of trained NETs made by szaza: https://drive.google.com/open?id=1GfS1Yle7Xari1tRUEi2EDYedFteAOaoN");
        }
    }
